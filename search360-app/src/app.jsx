...
import Dash from "./Site/dash/Dash";
import QrcodePage from "./app/Home/QrCode/Qrcode.jsx";
import Contrato from "./app/Home/Contrato/Contrato.jsx";
function App() {
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route element={<PrivateRoutes />}>
          ...
          <Route element={<QrcodePage />} path='/app/home/qrcode/:id' exact />
          ...
          <Route element={<Contrato />} path='/app/contrato/:id' exact />
        </Route>
      </Routes>
    </BrowserRouter>
  );
