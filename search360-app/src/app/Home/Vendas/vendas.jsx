  ...
  return (
    <div className="script-modal over">
      <div className="script-modal-content">
        ...
        <br />
        <p>
          Olá, Bom dia. O meu nome é _____, faço parte do Grupo Maps. O motivo
          do meu contato é referente a inclusão e a divulgação dos seus serviços
          dentro da plataforma de busca do google maps. Eu só vou precisar
          validar com o senhor algumas informações que vão ficar disponiveis
          pros seus clientes, tudo bem? O nome fantasia é esse mesmo_? o
          endereço cadastrado seria__? o numero pro cliente entrar em contato
          com o senhor é esse mesmo que estamos nos falando ou teria outro? Ele
          seria whatsapp? Qua seria o horário de funcionamento? De segunda a
          sexta? o email é___ Certo, vou estar falando agora o seu cnpj e a
          razao social e o senhor me confirma se está correto. Perfeito. O
          marketing vai entrar em contato com o senhor atraves do whatsapp e por
          lá é importante o senhor estar encaminhando até 30 fotos e 5 vídeos do
          seu serviço mensalmente pra estarmos atualizando a sua página. Caso o
          senhor tenha redes sociais, como facebook ou instagram, o senhor pode
          estar nos encaminhando o link para incluirmos na sua página. Além
          disso, também conseguimos criar um cartão interativo digital e uma
          logotipo para a sua empresa. Teria também uma divulgação, onde o
          senhor consegue escolher 5 bairros e municipios mais próximos para a
          divulgação da sua página. O senhor tem alguma dúvida até aqui?
          Referente a todo esse processo de criação, atualização e divulgação da
          sua página, gera um investimento no valor de 39,90 mensalmente, válido
          por 1 ano, com a data de vencimento somente para o dia ____ Lembrando
          que esse investimento é realizado somente após o senhor verificar
          todas as atualizações, ou seja, primeiro o senhor vera todos os
          serviços prestados e só depois irá realizar o investimento. Como a
          empresa do senhor é uma empresa privada, vamos encaminhar no seu
          whatsapp um termo de autorização onde o senhor vai estar autorizando
          os nossos serviços.
        </p>
      </div>
    </div>
...
function Vendas() {
  ...
  useEffect(() => {
    const unsubscribe = onAuthStateChanged(auth, (user) => {
      if (user) {
        ...
        if (
          user.uid === "HaJ1zQ3uhfUjN3Ucd49qmhbD9Ez2" || // felipe
          user.uid === "jQmq7NAw5KUsqIZQJanCXLYBDXh1" || // talita
          user.uid === "0nrVRt456BS3sAqqs9wwjYeCjfU2" || // fabiana
          user.uid === "MutIiMvE3jVzXOJ6OnN5CFAgHTt1" || // jessica mota
          user.uid === "1mlb3dC8GeemV3QqCOcrdP2jczn1" // test
        ) {
    ...
    const fetchData = async () => {
      try {
        ...
        if (q) {
          ...
          const contadorPagos = listaCli.filter(
            (cliente) => cliente.simPago
          ).length;
          ...
          <clientes>
            ${clientes
              ...
              <cliente>
                ...
                <vencimento>${formatarData(cliente.venc)}</vencimento>
                <pago>${cliente.simPago ? "sim" : "não"}</pago>
                <dataPagamento>${formatarData(
  ...
  return (
    <div>
      {showPopup && (
        <SweetAlert title="Horário do Almoço!" onConfirm={closePopup}>
          ...
          <div className="row">
            <div className="col-4 buttons">
              ...
              <button
                ...
                className="btn  btn-new2 btn-danger"
                type="button"
                id="button-addon2"
              >
              ...
              <button
                onClick={openModal}
                className="btn  btn-new2 btn-success"
                type="button"
                id="button-addon2"
              >
            ...
            <div className=" exibicao">
              ...
              <h4 className="qtdClientesAss">
                ...
                <b> CLIENTES: {quantidadeClientes}</b>
              </h4>
              {/* <h4>
