    ...
    return (
        <div>
            ...
            <div className="background9">
                <form className="box">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-12">
                            <label className="d-flex align-items-center justify-content-center" htmlFor="nomeFantasia"><b>Valor:</b></label>
                            <input
                                type="text"
                                id="nomeFantasia"
                                name="nomeFantasia"
                                value={cliente.valor || ''} 
                                onChange={(e) => setCliente({ ...cliente, valor: e.target.value })}
                                className="form-control"
            ...
            <div className="voltar row">
                ...
                <Link to="" onClick={handleClick} type="button" className="btn btn-primary btn-acao">Salvar</Link>
            </div>
        </div>
    );
}
